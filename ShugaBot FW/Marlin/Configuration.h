...
#define STRING_CONFIG_H_AUTHOR "(ata, ShugaBot)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {4000/25.4, 4000/25.4, 4000/25.4, 1380/4}  // default steps per unit for Ultimaker
